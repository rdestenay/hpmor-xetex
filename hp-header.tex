...
\newfontface\hp[ExternalLocation, LetterSpace=18.0, WordSpace=1.5]{Cambridge-Serial-Regular}
\newcommand{\lumos}[1]{{\hp\MakeUppercase{#1}}}
% Chapter numbers: Lumos (extreme spacing for effect)
\newfontface\hpchap[ExternalLocation, LetterSpace=40.0, WordSpace=2.0]{Cambridge-Serial-Bold}
%
